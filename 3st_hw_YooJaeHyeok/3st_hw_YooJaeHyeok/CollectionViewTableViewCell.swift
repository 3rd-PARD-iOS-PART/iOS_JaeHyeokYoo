...
class CollectionViewTableViewCell: UITableViewCell {
    ...
    let collectionView: UICollectionView = {
        ...
        collectionView.register(UICollectionViewCell.self, forCellWithReuseIdentifier: "CollectionViewTableViewCell")
...
extension CollectionViewTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CollectionViewTableViewCell", for: indexPath)
